    ...
    <div class="mdk-drawer-layout__content page" style="wi">
                ...
                <div class="flex">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item">UI Fase</li>
                            <li class="breadcrumb-item active">Lista</li>
                        </ol>
                    </nav>
                    <h1 class="m-0">Lista das Fases</h1>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid page__container">
            ...
            <div class="card card-form">
                @if ($updateMode)
                    @include('livewire.fase.update')
                @else
                    @include('livewire.fase.create')
                @endif
                            ...
                            <table class="table mb-0 thead-border-top-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 120px;">Nome da Role</th>
