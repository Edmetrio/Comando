...
<!-- Mirrored from demo.frontted.com/flowdash/120/blank.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Aug 2021 13:01:30 GMT -->
...
<body class="layout-default">
                            ...
                            <ul class="sidebar-menu">
                                ...
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button" data-toggle="collapse" href="#apps_menu">
                                        ...
                                        <span class="sidebar-menu-text">Gerir Esquadras</span>
                                        <span class="ml-auto sidebar-menu-toggle-icon"></span>
                                    </a>
    ...
    <!-- App -->
    <script src="{{ asset('assets/js/toggle-check-all.j') }}s"></script>
